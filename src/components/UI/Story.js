function Story({ Icon, imgName, name, index }) {
  return (
    <div
      className={`flex flex-col justify-between bg-${imgName} h-[190px] w-[110px] p-[10px] rounded-lg hover:scale-110 cursor-pointer transition duration-300 ease-in-out shadow-md ${
        index !== 0 && "ml-[15px]"
      }`}
    >
