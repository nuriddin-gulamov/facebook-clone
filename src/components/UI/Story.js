function Story({ Icon, img, name, index }) {
  return (
    <div
      className={`flex flex-col relative justify-center h-[190px] w-[110px] max-sm:h-[150px] max-sm:w-[80px] rounded-lg hover:scale-110 cursor-pointer transition duration-300 ease-in-out shadow-md ${
        index !== 0 && "ml-[15px]"
      }`}
    >
      <div className="relative">
        <img src={img} alt="" className="relative h-[190px] max-sm:h-[150px] object-contain" />
